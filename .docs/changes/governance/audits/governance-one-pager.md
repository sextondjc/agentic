...
This one-page briefing summarizes current governance status and links to canonical evidence artifacts.
...
| Customization Open Advisories | 0 | [audit.md](./../../customization/reviews/audit.md) |
| Skill Review MUST Failures | 0 | [full-skill-review-grid.md](./../../skill/reviews/full-skill-review-grid.md) |
...
|---|---|---|
| Core governance audit (rerun) | [governance-audit.md](./governance-audit.md) | Core standards green baseline |
| Reconciled comprehensive audit | [comprehensive-workspace-health-audit.md](./comprehensive-workspace-health-audit.md) | Cross-domain disposition |
| Skill review aggregate | [full-skill-review-grid.md](./../../skill/reviews/full-skill-review-grid.md) | Skill quality totals |
| Customization review aggregate (rerun) | [audit.md](./../../customization/reviews/audit.md) | Instruction and persona quality totals |
| Cadence workflow | `.github/workflows/governance-cadence.yml` | Scheduled governance automation evidence |
| Governance response record | [governance-response-and-script-library.md](./../../governance-response-and-script-library.md) | Implemented remediation evidence |
