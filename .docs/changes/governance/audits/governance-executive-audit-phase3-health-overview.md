...
| **Skill Registration & Discovery** | ⚠️ AT-RISK | 6/10 | 136 registered (100% catalog match); 6 on-disk unregistered (6 capacitor); orchestrate-capacitor description drift (9 vs 19 domains) | [governance-audit.md](./governance-audit.md), [delta-skills-audit-2026-05-06.md](./delta-skills-audit-2026-05-06.md) |
...
| **Total SHOULD Advisories** | 44 | 46 | +2 (orchestrate-* advisories) | ↑ Minor Increase |
...
| R-2 | **HIGH** | F-PH3-002, F-PH3-004 | Update `orchestrate-capacitor` description in skills-discovery-index.md to enumerate all 19 sub-domains from SKILL.md | Skills Owner | 2026-05-13 | 15 min | Description updated; count matches SKILL.md; delta re-audit confirms parity |
...
- **Phase 2 (Skills Delta) PASSED WITH ADVISORIES:** 125 new skills were added with full SKR-M* coverage (0 MUST failures); however, two index-description advisories surfaced (orchestrate-jquery and orchestrate-kendo sub-domain enumeration gaps), both categorized as TYP-S4 (advisory, not blocking).
...
**R-2: HIGH** — Update orchestrate-capacitor description (2026-05-13)  
