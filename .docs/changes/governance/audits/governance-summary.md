...
| `orchestrate-capacitor` description drift | Agents routing CapacitorJS compound requests may trigger the skill but then fail to handle 10 sub-domain inputs; silent partial-coverage failures |
