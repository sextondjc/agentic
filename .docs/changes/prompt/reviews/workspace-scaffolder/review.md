# Prompt Audit Review: workspace-scaffolder
...
| Field | Value |
|-------|-------|
| Prompt Name | workspace-scaffolder |
| Prompt Type | Task orchestration |
| Classification | Scaffolding |
| Last Updated | 2026-05-06 |
| Location | `.github/prompts/workspace-scaffolder.prompt.md` |
...
| **PRR-S1**: Prompt length & clarity | ✓ PASS | Concise yet complete; word count ~530; no redundancy detected |
...
|----------|--------|-----------|
| Scaffolding spec | ✓ Current | `.docs/specs/workspace-scaffolding-spec.md` |
| Architecture guidance | ✓ Current | `.github/instructions/architecture.instructions.md` |
