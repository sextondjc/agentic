# Prompt Audit Review: execute-artifact-condense
...
| Field | Value |
|-------|-------|
| Prompt Name | execute-artifact-condense |
| Prompt Type | Task execution |
| Classification | Execution |
| Last Updated | 2026-05-06 |
| Location | `.github/prompts/execute-artifact-condense.prompt.md` |
...
|-------|--------|----------|
| **PRR-M1**: Execution boundary clarity | ✓ PASS | Clear invocation contract; role definition precise |
...
| **PRR-S1**: Prompt length & clarity | ✓ PASS | Word count ~470; concise and complete |
...
| Execution patterns | ✓ Current | `.docs/specs/execution-orchestration-spec.md` |

---

## Recommendations

### Advisory F-003: Skill Routing Pattern Standardization
...
**Remediation**:
1. Change current routing to: `"Load and follow SKILL.md in the relevant skill folder for artifact condensing logic."`
2. Replace any conditional skill invocation with explicit workflow link
3. Add inline context after skill reference: `"This ensures [outcome X]"`
