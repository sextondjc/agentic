# Prompt Audit Review: review-project
...
| Field | Value |
|-------|-------|
| Prompt Name | review-project |
| Prompt Type | Review & analysis |
| Classification | Review |
| Last Updated | 2026-05-06 |
| Location | `.github/prompts/review-project.prompt.md` |
...
| **PRR-S1**: Prompt length & clarity | ✓ PASS | Concise yet complete; word count ~430; no redundancy detected |
...
|----------|--------|-----------|
| Review standards | ✓ Current | `.docs/specs/review-execution-patterns.md` |
| Project assessment spec | ✓ Current | `.docs/specs/project-assessment-spec.md` |
