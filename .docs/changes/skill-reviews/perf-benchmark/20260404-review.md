...
- Save this file to .docs/changes/skill-reviews/perf-benchmark/20260404-review.md
...
| SKR-S4 | Pass | .github/skills/perf-benchmark/SKILL.md | Skill is self-contained with explicit Inputs, Required Outputs, and Workflow execution context. |
...
|---|---|---:|---:|---|---|
| perf-benchmark | Pass | 0 | 0 | None | .docs/changes/skill-reviews/perf-benchmark/20260404-review.md |