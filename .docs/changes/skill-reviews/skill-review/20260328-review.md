...
|---|---|---|---|
| SKR-M1 | Pass | .github/skills/skill-review/SKILL.md | Baseline review found a single primary objective for the skill. |
| SKR-M2 | Pass | .github/skills/skill-review/SKILL.md | Front matter includes required name and description fields. |
| SKR-M3 | Pass | .github/skills/skill-review/SKILL.md | Triggering guidance is present in description or body sections. |
