...
- [customization-taxonomy-promotion-changes.md](./customization-taxonomy-promotion-changes.md) - Progressive execution log for taxonomy promotion work.
- [customization-taxonomy-promotion-boundary.md](./../adr/customization-taxonomy-promotion-boundary.md) - ADR for taxonomy promotion boundary and precedence model.
- [governance-audit.md](./governance/audits/governance-audit.md) - Post-change governance validation report.
...
- [customization-taxonomy-promotion-changes.md](./customization-taxonomy-promotion-changes.md) - Change traceability artifact.
- [customization-taxonomy-promotion-boundary.md](./../adr/customization-taxonomy-promotion-boundary.md) - Durable architecture/governance decision record.
- [governance-audit.md](./governance/audits/governance-audit.md) - Governance standards validation evidence.
