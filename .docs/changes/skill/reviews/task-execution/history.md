...
---
Merged snapshot from .docs/changes/skill/reviews/task-execution/20260409-review.md
---
...
- Save this file to .docs/changes/skill-reviews/task-execution/20260409-review.md
...
|---|---|---|---|
| SKR-M1 | Pass | .github/skills/task-execution/SKILL.md | Skill objective is scoped to a single review/use-case domain in static analysis. |
| SKR-M2 | Pass | .github/skills/task-execution/SKILL.md | Front matter includes required name and description fields. |
| SKR-M3 | Pass | .github/skills/task-execution/SKILL.md | Trigger guidance is explicit in description and/or heading sections. |
| SKR-M4 | Pass | .github/skills/task-execution/SKILL.md | Frontmatter name 'task-execution' matches expected skill name 'task-execution'. |
...
|---|---|---:|---:|---|---|
| task-execution | Pass | 0 | 0 | None | .docs/changes/skill-reviews/task-execution/20260409-review.md |
