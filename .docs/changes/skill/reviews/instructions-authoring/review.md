...
|---|---|---|---|
| SKR-M1 | Pass | .github/skills/instructions-authoring/SKILL.md | Single objective remains clearly scoped. |
| SKR-M2 | Pass | .github/skills/instructions-authoring/SKILL.md | Front matter is valid for discovery. |
| SKR-M3 | Pass | .github/skills/instructions-authoring/SKILL.md | Trigger guidance is explicit. |
| SKR-S1 | Pass | .github/skills/instructions-authoring/SKILL.md | Concrete references/assets are present. |
| SKR-S2 | Pass | .github/skills/*/SKILL.md | No harmful overlap or contradictory behavior detected. |
| SKR-S3 | Pass | .github/skills/instructions-authoring/SKILL.md | No broken or placeholder markdown links detected. |
