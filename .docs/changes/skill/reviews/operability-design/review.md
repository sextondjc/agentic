...
| SKR-S1 | Pass | .github/skills/operability-design/references/ | Concrete references or reusable assets are present. |
...
| SKR-S5 | Pass | .github/skills/operability-design/SKILL.md | Skill wording is within the conservative brevity baseline (553 words) and shows no automatic verbosity concern. |
...
|---|---|---:|---:|---|---|
| operability-design | Pass | 0 | 0 | None | .docs/changes/skill/reviews/operability-design/review.md |