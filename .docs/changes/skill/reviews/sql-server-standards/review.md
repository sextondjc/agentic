...
| SKR-S1 | Pass | .github/skills/sql-server-standards/references/ | Concrete references or reusable assets are present. |
...
| SKR-S5 | Pass | .github/skills/sql-server-standards/SKILL.md | Skill wording is within the conservative brevity baseline (634 words) and shows no automatic verbosity concern. |
...
|---|---|---:|---:|---|---|
| sql-server-standards | Pass | 0 | 0 | None | .docs/changes/skill/reviews/sql-server-standards/review.md |