# capacitor-auth-session History

## Skill Metadata

- Skill Name: capacitor-auth-session
- Skill Path: .github/skills/capacitor-auth-session/SKILL.md
- Created: 2026-05-13
...
- Source Report: .docs/changes/skill/reviews/capacitor-auth-session/review.md
