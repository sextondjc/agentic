# sql-server-security History

## Skill Metadata

- Skill Name: sql-server-security
- Skill Path: .github/skills/sql-server-security/SKILL.md
- Created: 2026-05-13
...
- Source Report: .docs/changes/skill/reviews/sql-server-security/review.md
