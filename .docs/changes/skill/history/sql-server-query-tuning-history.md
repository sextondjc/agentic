# sql-server-query-tuning History

## Skill Metadata

- Skill Name: sql-server-query-tuning
- Skill Path: .github/skills/sql-server-query-tuning/SKILL.md
- Created: 2026-05-13
...
- Source Report: .docs/changes/skill/reviews/sql-server-query-tuning/review.md
