# mcp-server-quality-gate History

## Skill Metadata

- Skill Name: mcp-server-quality-gate
- Skill Path: .github/skills/mcp-server-quality-gate/SKILL.md
- Created: 2026-05-13
...
- Source Report: .docs/changes/skill/reviews/mcp-server-quality-gate/review.md
