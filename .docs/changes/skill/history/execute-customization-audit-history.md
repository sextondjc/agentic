...
| SKR-S3 | Advisory | Found 0 placeholder and 1 broken links. |
...
|---|---|---|---|---|
| REC-003 | Replace placeholder/broken markdown links with resolvable targets. | Proposed | N/A | Link integrity advisory. |
