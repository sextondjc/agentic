# sql-server-diagnostics History

## Skill Metadata

- Skill Name: sql-server-diagnostics
- Skill Path: .github/skills/sql-server-diagnostics/SKILL.md
- Created: 2026-05-13
...
- Source Report: .docs/changes/skill/reviews/sql-server-diagnostics/review.md
