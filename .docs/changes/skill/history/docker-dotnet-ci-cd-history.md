# docker-dotnet-ci-cd History

## Skill Metadata

- Skill Name: docker-dotnet-ci-cd
- Skill Path: .github/skills/docker-dotnet-ci-cd/SKILL.md
- Created: 2026-06-01
...
- Source Report: .docs/changes/skill/reviews/docker-dotnet-ci-cd/review.md
...
| SKR-M4 | Pass | Frontmatter name 'docker-dotnet-ci-cd' matches expected skill name 'docker-dotnet-ci-cd'. |
