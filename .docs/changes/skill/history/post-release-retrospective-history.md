# post-release-retrospective History

## Skill Metadata

- Skill Name: post-release-retrospective
- Skill Path: .github/skills/post-release-retrospective/SKILL.md
- Created: 2026-05-13
...
- Source Report: .docs/changes/skill/reviews/post-release-retrospective/review.md
...
| SKR-S1 | Advisory | No references/assets folder; add concrete templates or examples. |
...
|---|---|---|---|---|
| REC-001 | Add references assets (templates/examples/tools) for this skill. | Proposed | N/A | Baseline advisory. |
| REC-002 | Normalize description to start with "Use when...". | Proposed | N/A | Discovery consistency. |
