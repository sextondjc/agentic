...
| WS-03 | Catalog integration | Execution | `instructions-authoring`, `index-docs` | Matrix in `skills-discovery-index.md`, bundle codes in `agents-discovery-index.md`, Discipline-change protocol in `governance-lifecycle.instructions.md` | WS-01 done | P2 |
...
| `.github/catalogs/skills-discovery-index.md` | Modify | WS-03 | Add N01, N02, N04, N06, N07 entries; add note about PDL matrix coverage |
| `.github/catalogs/agents-discovery-index.md` | Modify | WS-03 | Add PDL bundle metadata note; reference matrix for routing context |
...
| AC-004 | `skills-discovery-index.md` has rows for all five new skills with correct primary and secondary lane assignments. |
...
- [ ] Link from `instructions-discovery-index.md`.
...
- [ ] Add to `skills-discovery-index.md`.
...
**Files:**
- Modify: `.github/catalogs/skills-discovery-index.md`
- Modify: `.github/instructions/governance-lifecycle.instructions.md`
- Modify: `.github/catalogs/agents-discovery-index.md`

- [ ] Add rows for all five new skills to `skills-discovery-index.md` with lanes, when-to-use, and skill file link.
...
- [ ] Add a note to `agents-discovery-index.md` referencing the PDL matrix as the coverage map for agent routing context.
...
- [ ] Write a script that reads `skills-discovery-index.md` and compares listed skills against the bundle legend in the matrix document.
- [ ] Detect: any bundle member that no longer exists as a skill or agent file (asset drift signal).
- [ ] Detect: matrix document older than the last modification of `skills-discovery-index.md` (stale matrix signal).
...
- [ ] Verify `skills-discovery-index.md` has rows for all five new skills.
- [ ] Verify `governance-lifecycle.instructions.md` contains DEC-PDL-07.
- [ ] Verify `governance-release.instructions.md` exists and is linked from `instructions-discovery-index.md`.
...
| R-03 | `Invoke-MatrixCoverageCheck.ps1` false-positives on renamed assets | Low | Script compares canonical names from `skills-discovery-index.md` not file paths |
