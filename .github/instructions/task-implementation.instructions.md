...
Keep this file policy-only. Use [SKILL.md](./../skills/task-execution/SKILL.md) for same-session execution workflow and [SKILL.md](./../skills/executing-plans/SKILL.md) for dedicated-session execution checkpoints.
...
- Use [SKILL.md](./../skills/executing-plans/SKILL.md) for dedicated-session execution with explicit checkpoints.
