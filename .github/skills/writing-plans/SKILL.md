...
> **For agentic workers:** REQUIRED WORKFLOW: Use the `planning-research` agent for planning handoff, then use `csharp-engineer` or `debug` to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
