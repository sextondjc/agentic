...
Research-only specialist. Create and edit files in `./__DOCS_ROOT__/research/<domain>/<topic>/` only. Do not modify source code, configurations, or other project files.
...
Use granular paths: `__DOCS_ROOT__/research/<domain>/<topic>/<artifact>.md`.
Do not place research files directly in `__DOCS_ROOT__/research/` unless the user explicitly requests a flat structure.
...
- Source-backed research artifact under `__DOCS_ROOT__/research/<domain>/<topic>/`.
