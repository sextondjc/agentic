...
| SKR-S5 | Pass | Skill wording is within the conservative brevity baseline (805 words) and shows no automatic verbosity concern. |
...
| SKR-M2 | Pass | Front matter includes required name and description fields. |
| SKR-M3 | Pass | Trigger guidance is explicit in description and/or heading sections. |
| SKR-M4 | Pass | Frontmatter name 'jquery-ajax' matches expected skill name 'jquery-ajax'. |
