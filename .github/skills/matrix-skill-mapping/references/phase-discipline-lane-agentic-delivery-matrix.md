...
>
> **Canonical source:** This file is the canonical matrix.
...
| X10 | Governance and documentation review | `governance-briefer`, `governance-audit`, `governance-summarize`, `audit-agent`, `audit-instructions`, `audit-prompts`, `technical-docs.instructions.md` |
| X11 | Product and delivery planning | `prd-generator`, `delivery-status-grid`, `writing-plans`, `plans` |
| X12 | Customisation architecture | `route-customization`, `asset-naming-taxonomy`, `agent-authoring`, `instructions-authoring`, `skills-authoring`, `sync-customizations`, `sync-skills` |
...
| Asset drift | A bundle member is renamed, removed, or split | Bundle legend becomes inconsistent with skill-discovery-index.md; use `sync-customizations` or `governance-audit` |
