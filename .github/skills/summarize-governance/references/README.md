# Summarize Governance — Reference Assets

This references folder is currently empty.

Reserve it for concrete summarize-governance assets such as briefing templates, example summaries, or formatting guidance when those files are added.
