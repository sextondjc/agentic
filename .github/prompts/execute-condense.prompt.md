...
|---|---|---|---|---|
| <skill-review/validate-customization/skills-authoring/agent-authoring/instructions-authoring/route-customization> | <accepted recommendation or post-change validation handoff> | Yes/No | <path or N/A for recommendation-only run> | <status> |
